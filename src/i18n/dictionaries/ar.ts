...
const servicesPage = {
  ...
  facialCosmetic: {
    ...
    proceduresLead: "اضغط على أي إجراء لقراءة شرحه الكامل.",
  ...
  items: [
    ...
    // Round 2026-07-26 (doctor feedback) — TODO(content): draft, needs clinical sign-off, same convention as the newer entries above.
    {
      ...
      overview:
        "تُعنى جراحة إصابات وكسور الوجه بتقييم وعلاج الإصابات الناتجة عن الصدمات أو الحوادث — من كسور عظام الفك أو الوجنة أو محجر العين أو الأنف إلى جروح الأنسجة الرخوة للوجه — مع إعطاء الأولوية أولاً للحفاظ على الوظيفة ثم استعادة الشكل الطبيعي.",
      suitableForHeading: "لمن تناسب هذه الجراحة عادةً؟",
      suitableFor: [
      ...
      processHeading: "مراحل العلاج",
      process: [
        { title: "التقييم العاجل", body: "مراجعة سريعة لحالة المريض ومدى شدة إصابة الوجه." },
        { title: "التصوير الطبي", body: "تحديد دقيق لموقع ومدى الكسر أو الإصابة." },
        { title: "العلاج أو الجراحة", body: "إصلاح الكسر أو الجرح بما يتناسب مع مدى الإصابة." },
        { title: "الرعاية والمتابعة", body: "المرافقة خلال فترة التعافي ومراجعة وظيفة الوجه." },
      ],
      faqHeading: "أسئلة شائعة",
      faq: [
