...
export const assistantFlow = {
  ...
  ui: {
    ...
    costQuestionEyebrow: "استفسار عن التكلفة",
    costQuestionTitle: "تقدير أولي للتكلفة",
  ...
  steps: {
    ...
    costQuestion: {
      intro: "يعتمد التقدير الأولي للتكلفة على نوع الخدمة والفحص السريري. لمعرفة تقدير تقريبي للتكلفة بعد المراجعة الأولية، يرجى اختيار الخدمة التي تهمكم.",
    },
    imageUploadFuture: {
  ...
  payment: {
    ...
    gatewayPendingNotice: "سيتم تفعيل الدفع الإلكتروني عند ربط بوابة الدفع.",
    amountLabel: "المبلغ",
  ...
  phoneVerification: {
    ...
    smsUnavailableMessage: "التحقق من الرقم قيد الاتصال بنظام الرسائل النصية. يرجى التواصل مع العيادة عبر الهاتف أو واتساب.",
