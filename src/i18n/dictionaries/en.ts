...
export const faqSection = {
  ...
  items: [
    ...
    { category: "rhinoplasty", question: "When can I start wearing glasses again?", answer: "Wearing glasses is usually not recommended for up to 3 months after surgery, unless approved by your doctor." },
