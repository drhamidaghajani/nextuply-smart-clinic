...
const TRAUMA_TOPIC_RULES: Record<Locale, Array<{ requireAll: string[]; serviceId: ServiceId | null; topicLabel: string }>> = {
  fa: [
    ...
    // Round 2026-07-26 (doctor feedback, per Hamid — two new main
    // services): general facial-bone fractures that aren't the already-
    // specific nose/jaw rules above route to the new trauma service;
    // listed right after those two so a nose/jaw fracture still wins its
    // more specific rule first (order matters — first match wins).
    { requireAll: ["گونه", "شکست"], serviceId: "facial-trauma-surgery", topicLabel: "شکستگی استخوان گونه" },
    { requireAll: ["کاسه چشم", "شکست"], serviceId: "facial-trauma-surgery", topicLabel: "شکستگی کاسه چشم" },
    { requireAll: ["صورت", "شکست"], serviceId: "facial-trauma-surgery", topicLabel: "شکستگی صورت" },
    { requireAll: ["صورت", "ضربه"], serviceId: "facial-trauma-surgery", topicLabel: "ضربه به صورت" },
    { requireAll: ["تصادف", "صورت"], serviceId: "facial-trauma-surgery", topicLabel: "آسیب صورت پس از تصادف" },
    { requireAll: ["دندان", "ضربه"], serviceId: "facial-trauma-surgery", topicLabel: "آسیب دندانی ناشی از ضربه" },
    ...
    // Round 2026-07-26 (doctor feedback) — reconstruction-related requests,
    // e.g. after an old fracture healed poorly. Listed after the acute-
    // trauma rules above (a fresh fracture should still route to
    // facial-trauma-surgery) but before the fully generic catch-all below.
    { requireAll: ["بازسازی", "صورت"], serviceId: "facial-reconstruction-surgery", topicLabel: "نیاز به بازسازی صورت" },
    { requireAll: ["بازسازی", "فک"], serviceId: "facial-reconstruction-surgery", topicLabel: "نیاز به بازسازی فک" },
    { requireAll: ["بازسازی", "استخوان"], serviceId: "facial-reconstruction-surgery", topicLabel: "نیاز به بازسازی استخوان صورت" },
  ...
  en: [
    ...
    { requireAll: ["cheek", "fracture"], serviceId: "facial-trauma-surgery", topicLabel: "a fractured cheekbone" },
    { requireAll: ["cheekbone", "broken"], serviceId: "facial-trauma-surgery", topicLabel: "a fractured cheekbone" },
    { requireAll: ["eye socket", "fracture"], serviceId: "facial-trauma-surgery", topicLabel: "an eye socket fracture" },
    { requireAll: ["face", "fracture"], serviceId: "facial-trauma-surgery", topicLabel: "a facial fracture" },
    { requireAll: ["face", "trauma"], serviceId: "facial-trauma-surgery", topicLabel: "facial trauma" },
    { requireAll: ["accident", "face"], serviceId: "facial-trauma-surgery", topicLabel: "facial injury after an accident" },
    { requireAll: ["tooth", "trauma"], serviceId: "facial-trauma-surgery", topicLabel: "dental trauma from an impact" },
    ...
    { requireAll: ["reconstruction", "face"], serviceId: "facial-reconstruction-surgery", topicLabel: "a facial reconstruction need" },
    { requireAll: ["reconstruction", "jaw"], serviceId: "facial-reconstruction-surgery", topicLabel: "a jaw reconstruction need" },
    { requireAll: ["reconstruction", "bone"], serviceId: "facial-reconstruction-surgery", topicLabel: "a facial bone reconstruction need" },
  ...
  ar: [
    ...
    { requireAll: ["خد", "كسر"], serviceId: "facial-trauma-surgery", topicLabel: "كسر في عظم الخد" },
    { requireAll: ["محجر العين", "كسر"], serviceId: "facial-trauma-surgery", topicLabel: "كسر في محجر العين" },
    { requireAll: ["وجه", "كسر"], serviceId: "facial-trauma-surgery", topicLabel: "كسر في الوجه" },
    { requireAll: ["وجه", "صدمة"], serviceId: "facial-trauma-surgery", topicLabel: "صدمة في الوجه" },
    { requireAll: ["حادث", "وجه"], serviceId: "facial-trauma-surgery", topicLabel: "إصابة في الوجه بعد حادث" },
    { requireAll: ["سن", "صدمة"], serviceId: "facial-trauma-surgery", topicLabel: "إصابة سنية بسبب صدمة" },
    ...
    { requireAll: ["إعادة بناء", "وجه"], serviceId: "facial-reconstruction-surgery", topicLabel: "الحاجة لإعادة بناء الوجه" },
    { requireAll: ["إعادة بناء", "فك"], serviceId: "facial-reconstruction-surgery", topicLabel: "الحاجة لإعادة بناء الفك" },
    { requireAll: ["إعادة بناء", "عظم"], serviceId: "facial-reconstruction-surgery", topicLabel: "الحاجة لإعادة بناء عظام الوجه" },
