...
export const faqSection = {
  ...
  items: [
    ...
    { category: "rhinoplasty", question: "متى يمكنني ارتداء النظارات؟", answer: "لا يُنصح عادة باستخدام النظارات لمدة تصل إلى 3 أشهر بعد العملية، إلا بموافقة الطبيب." },
...
export const assistantFlow = {
  ...
  triageQuestions: {
    ...
    "facial-trauma-surgery": [
      "متى حدثت هذه الإصابة أو الصدمة؟",
      "هل تعانون من ألم شديد أو تورم أو نزيف في المنطقة المصابة؟",
      "هل لديكم صور أشعة أو تقرير طبي من زيارة طارئة؟",
    ],
    // Round 2026-07-26 (doctor feedback) — TODO(content): draft, needs clinical sign-off.
    "facial-reconstruction-surgery": [
      "ما سبب الحاجة لإعادة البناء؟ (إصابة، مرض، أو جراحة سابقة)",
      "ما المنطقة من الوجه التي تحتاج إلى إعادة بناء؟",
      "هل لديكم صور أو فحص CBCT أو سجلات طبية ذات صلة؟",
    ],
  },
  ...
  serviceShortLabels: {
    ...
    "facial-trauma-surgery": "إصابات الوجه",
    "facial-reconstruction-surgery": "إعادة بناء الوجه",
  ...
  aiConversation: {
    ...
    // Round 2026-07-23 (Urgency & Safety Router) — النص الحرفي المطلوب لحالة كسر الأنف، بالإضافة إلى قالب معمّم لأي موضوع طارئ/صدمة آخر.
    urgent: {
      noseTraumaResponse:
        "فهمت؛ الأمر يتعلق بكسر في الأنف وطلب موعد عاجل.\n\nإذا كانت الإصابة حديثة، أو لديكم نزيف شديد، أو أصبح التنفس من الأنف صعبًا، أو لديكم ألم أو تورم شديد، أو تغيّر شكل الأنف بوضوح، فمن الأفضل عدم الانتظار والتواصل مع العيادة لمراجعة عاجلة، أو التوجه إلى مركز طوارئ إذا كانت الأعراض شديدة.\n\nللتنسيق السريع مع الدكتور صديقي، يمكنني تسجيل طلب مراجعة عاجلة للأنف ليتصل بكم فريق العيادة.\n\nمتى حدثت الإصابة؟",
      genericResponseTemplate:
        "فهمت؛ الأمر يتعلق بـ{topic} وطلب موعد عاجل.\n\nإذا كانت أعراضكم شديدة أو حديثة أو تزداد سوءًا، فمن الأفضل عدم الانتظار والتواصل مع العيادة لمراجعة عاجلة، أو التوجه إلى مركز طوارئ إذا كانت الأعراض شديدة.\n\nللتنسيق السريع مع الدكتور صديقي، يمكنني تسجيل طلب مراجعة عاجلة ليتصل بكم فريق العيادة.\n\nمنذ متى بدأت هذه المشكلة؟",
      genericTopicLabel: "مراجعة عاجلة",
      callCta: "طلب اتصال عاجل من العيادة",
      bookReviewTemplate: "حجز مراجعة {service}",
      bookReviewGeneric: "حجز مراجعة عاجلة",
      within48hCta: "منذ أقل من ٤٨ ساعة",
      moreThanFewDaysCta: "منذ أكثر من بضعة أيام",
      breathingIssueCta: "لدي مشكلة في التنفس",
      recentTraumaReply:
        "فهمت. في الإصابات الحديثة (أقل من ٤٨ ساعة)، تكون المراجعة المبكرة أكثر أهمية. أقترح التنسيق مع العيادة في أقرب وقت ممكن، أو التوجه إلى مركز طوارئ إذا كانت الأعراض شديدة.",
      olderTraumaReply:
        "فهمت. حتى لو مرت بضعة أيام، فإن مراجعة الطبيب مهمة للتأكد من أن التعافي يسير بشكل صحيح. يمكنكم التنسيق مع العيادة عبر المسارات التالية.",
      breathingIssueReply:
        "صعوبة التنفس علامة لا ينبغي تجاهلها. إذا أصبح تنفسكم صعبًا بوضوح، يرجى التواصل مع العيادة في أقرب وقت ممكن، أو التوجه إلى مركز طوارئ إذا كانت الأعراض شديدة.",
      callRequestConfirmed:
        "تم تسجيل طلب الاتصال العاجل الخاص بكم. يُحفظ طلبكم مع ملخص هذه المحادثة ليتابعه فريق العيادة. سيتصل بكم فريقنا في أقرب وقت ممكن.",
    },
  },
  contextualAsk: {
...
const servicesPage = {
  ...
  facialCosmetic: {
    heroSubtitle:
      "تعرض هذه الصفحة أنواع جراحات تجميل الوجه التي يجريها الدكتور صديقي؛ من شد الوجه وتشكيله إلى تصحيح الذقن والخد والفك والجفن. الهدف هو الوصول إلى تناسب طبيعي للوجه، والحفاظ على الهوية الفردية، واختيار الطريقة المناسبة بناءً على تشريح كل شخص.",
    heroCtaProcedures: "عرض أنواع الجراحات",
    navAriaLabel: "التنقل بين جراحات تجميل الوجه",
    proceduresEyebrow: "تجميل الوجه",
    proceduresHeading: "أنواع جراحات تجميل الوجه",
    proceduresLead:
      "إذا كنت تعاني من الذقن المزدوجة، أو انتفاخ الجفون، أو ترهل الحاجب أو جلد الوجه، أو خدين وزوايا وجه غير بارزة، أو خدين ممتلئين بشكل زائد، يمكنك في هذه الصفحة استكشاف المسارات المختلفة لجراحات تجميل الوجه، واختيار أي منها لقراءة شرحه وإرشادات العناية الخاصة به.",
    cardCta: "عرض التفاصيل",
    cardCtaClose: "إخفاء التفاصيل",
    suitableForLabel: "لمن يناسب هذا الإجراء؟",
    goalsLabel: "هدف / نتيجة هذا الإجراء",
    processLabel: "المسار العام للعلاج",
    careLabel: "أهم إرشادات العناية",
    procedureCta: "طلب استشارة حول هذه الجراحة",
    careHeading: "إرشادات عامة للعناية قبل وبعد جراحات تجميل الوجه",
    careLead: "هذه إرشادات عامة ولا تُغني عن التعليمات الخاصة التي يحددها الطبيب.",
    carePreHeading: "العناية قبل الجراحة",
    carePreItems: [
      "مراجعة التاريخ الطبي والأدوية والحساسية في جلسة الاستشارة",
      "إجراء التصوير أو الفحوصات اللازمة عند توصية الطبيب",
      "تجنب تناول أي أدوية أو مكملات دون استشارة طبية",
      "التنسيق بشأن موعد الجراحة والعناية بعدها ومرافق المريض",
      "امتلاك توقعات واقعية بشأن النتيجة النهائية",
    ],
    carePostHeading: "العناية بعد الجراحة",
    carePostItems: [
      "تناول الأدوية والالتزام بتوصيات الطبيب",
      "تجنب الضغط أو الصدمات أو التدليك في المنطقة التي أُجريت فيها الجراحة",
      "التحكم في التورم والكدمات حسب تعليمات الطبيب",
      "تجنب النشاط الشاق حتى الوقت المناسب",
      "حضور جلسات المتابعة لمراجعة مسار التعافي",
    ],
    careNote: "يحدد الطبيب إرشادات العناية الدقيقة لكل شخص بعد الفحص، بناءً على نوع الجراحة والحالة الجسدية وخطة العلاج.",
    faqHeading: "الأسئلة الشائعة",
    faq: [
      {
        question: "هل تناسب جميع جراحات تجميل الوجه كل الأشخاص؟",
        answer:
          "لا. يعتمد اختيار الطريقة المناسبة على شكل الوجه والعمر وجودة الجلد والبنية العظمية والتاريخ الطبي وتوقعات الشخص. ويُتخذ القرار النهائي بعد الفحص والاستشارة المتخصصة.",
      },
      {
        question: "هل يمكن إجراء عدة جراحات تجميل للوجه في وقت واحد؟",
        answer: "في بعض الحالات قد يمنح الجمع بين عدة إجراءات نتيجة أكثر انسجاماً، لكن ذلك يعتمد على حالة الشخص ونوع الجراحات ورأي الطبيب.",
      },
      {
        question: "هل ستكون نتيجة هذه الجراحات طبيعية؟",
        answer: "الهدف في تصميم العلاج هو الوصول إلى نتيجة متناسبة وطبيعية، بحيث تُحفظ هوية الوجه ولا تحدث تغييرات مفرطة أو مبالغ فيها.",
      },
      {
        question: "هل جراحة تجميل الأنف مدرجة في هذه الصفحة؟",
        answer: "لا. لجراحة تجميل الأنف صفحة مستقلة ومسار منفصل معروض في الموقع.",
      },
    ],
    finalCtaHeading: "اختيار الطريقة المناسبة يبدأ باستشارة متخصصة",
    finalCtaBody:
  ...
  items: [
    {
      ...
      overview: "زراعة الأسنان إجراء لاستبدال جذر السن المفقود بدعامة من التيتانيوم، توفر أساساً ثابتاً لتاج السن.",
      suitableForHeading: "لمن تناسب هذه الخدمة عادةً؟",
      suitableFor: [
        "من فقدوا سناً واحداً أو أكثر",
        "من لديهم كثافة عظمية غير كافية أو تحلل في العظم واللثة",
        "من يبحثون عن بديل أكثر ثباتاً من الحلول المتحركة",
        "من لديهم حالة جسدية خاصة، أو يتناولون أدوية مرتبطة بهشاشة العظام، أو لديهم تاريخ من العلاج الكيميائي أو الإشعاعي، يجب إبلاغ الطبيب بذلك خلال جلسة الاستشارة",
      ],
    ...
    },
    {
      ...
      processHeading: "مراحل جراحة ضرس العقل والأسنان المطمورة",
      process: [
        { title: "استشارة متخصصة وتقييم حالة السن", body: "مراجعة الأعراض وموقع السن وأي تاريخ من الألم أو العدوى أو الضغط على الأسنان المجاورة." },
        { title: "التصوير والتقييم الدقيق", body: "مراجعة صورة الأشعة أو فحص CBCT عند الحاجة، لتحديد عمق الطمر ومسار السن وقربه من العصب أو الجيب الفكي." },
        { title: "اختيار الأسلوب الجراحي", body: "تحديد الطريقة المناسبة بناءً على عمق الطمر والقرب من العصب ودرجة الوصول وحالة المريض." },
        { title: "إجراء جراحة آمنة ودقيقة", body: "استخراج السن المطمور بهدف تقليل الضرر للأنسجة المحيطة والحفاظ على سلامة التراكيب الحساسة." },
        { title: "الرعاية والمتابعة بعد الجراحة", body: "تقديم التوصيات اللازمة للتحكم في الألم والتورم ونظافة الفم ومتابعة مسار الشفاء." },
      ],
      faqHeading: "أسئلة شائعة",
      faq: [
        {
          question: "هل جراحة السن المطمور ضرورية دائماً؟",
          answer:
            "لا. تُحدَّد ضرورة الجراحة بناءً على الفحص والتصوير وأعراض المريض وتشخيص الطبيب. في بعض الحالات، يُنصح بالجراحة للوقاية من الألم أو العدوى أو الضرر للأسنان المجاورة أو تكوّن كيس أو ورم أو ازدحام الأسنان.",
        },
        { question: "كم تستغرق فترة التعافي؟", answer: "عادةً فترة قصيرة؛ التفاصيل الدقيقة تُشرح خلال الاستشارة." },
        {
          question: "هل تُجرى جراحة ضرس العقل والأسنان المطمورة دائماً تحت التخدير العام؟",
          answer:
            "لا. في كثير من الحالات، تُجرى الجراحة بالتخدير الموضعي. عادةً ما يُطرح التخدير العام أو التسكين عندما يكون عمق الطمر كبيراً، أو برغبة المريض، أو عند وجود خوف أو قلق شديد. يُتخذ القرار النهائي بناءً على تشخيص الطبيب وتقديره.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      suitableForHeading: "لمن تناسب هذه الجراحة عادةً؟",
      suitableFor: [
        "من يعانون من بروز الفك السفلي",
        "من يعانون من تراجع الفك السفلي",
        "من يعانون من بروز أو تراجع الفك العلوي",
        "من يعانون من ضيق الفك العلوي",
        "الشخير واضطرابات النوم الناتجة عن تراجع الفك",
      ...
      faq: [
        ...
        {
          question: "كم تستغرق فترة التعافي من هذه الجراحة؟",
          answer: "عادةً ما تستغرق فترة التعافي والنقاهة نحو أسبوع، لكنها قد تختلف حسب حالة المريض وتعقيد الجراحة؛ تُشرح التفاصيل الدقيقة خلال الاستشارة.",
        },
      ],
    },
    {
    ...
    // Round 2026-07-26 (doctor feedback) — TODO(content): draft, needs clinical sign-off, same convention as the newer entries above.
    {
      ...
      eyebrow: "إصابات وكسور الوجه",
      title: "جراحة إصابات وكسور الوجه",
      subtitle: "علاج إصابات الوجه والكسور والجروح الناتجة عن الصدمات أو الحوادث، بهدف الحفاظ على الوظيفة واستعادة الشكل الطبيعي للوجه.",
      overview:
        "تُعنى جراحة إصابات وكسور الوجه بتقييم وعلاج الإصابات الناتجة عن الصدمات أو الحوادث — من كسور عظام الفك أو الوجنة أو محجر العين أو الأنف إلى جروح الأنسجة الرخوة للوجه — مع إعطاء الأولوية أولاً للحفاظ على الوظيفة، ثم استعادة الشكل الطبيعي والجمال وثقة المريض بنفسه.",
      suitableForHeading: "لمن تناسب هذه الجراحة عادةً؟",
      suitableFor: [
        "من يعانون من كسر في عظام الوجه (الفك أو الوجنة أو محجر العين أو الأنف) بعد صدمة أو حادث",
        "من لديهم جرح أو إصابة في الأنسجة الرخوة للوجه تحتاج إلى إصلاح عاجل",
        "من لديهم إصابة سنية ناتجة عن صدمة وتحتاج إلى تقييم عاجل",
      ],
      consultationPathHeading: "مسار الاستشارة",
      consultationPath: "في إصابات الوجه الحادة، يُعد التقييم العاجل والتصوير لتحديد مدى الإصابة شرطاً أساسياً لأي قرار علاجي.",
      processHeading: "مراحل العلاج",
      process: [
        { title: "تقييم وتشخيص دقيق", body: "مراجعة سريعة لحالة المريض وتحديد شدة ونوع إصابة الوجه." },
        { title: "التصوير والتخطيط الرقمي", body: "تحديد دقيق لموقع ومدى الكسر؛ وعند الحاجة، التخطيط الجراحي باستخدام التكنولوجيا الرقمية." },
        { title: "جراحة مفتوحة أو مغلقة", body: "إجراء الجراحة بما يتناسب مع نوع الكسر، وعند الحاجة، التثبيت بألواح وبراغي التيتانيوم." },
        { title: "المتابعة وإعادة التأهيل", body: "المرافقة خلال فترة التعافي وإعادة التأهيل الوظيفي والجمالي للوجه." },
      ],
      faqHeading: "أسئلة شائعة",
      faq: [
        { question: "هل يجب أن أتصرف فوراً في حال وجود كسر في الوجه؟", answer: "نعم، يجب تقييم إصابات الوجه في أسرع وقت ممكن؛ تواصلوا عبر المساعد الذكي أو مباشرة مع العيادة." },
        { question: "هل تحتاج جميع كسور الوجه إلى جراحة؟", answer: "لا، حسب نوع الكسر ومداه، يمكن التعامل مع بعض الحالات بطرق غير جراحية؛ يُحدَّد ذلك خلال الفحص." },
        { question: "كم تستغرق فترة التعافي من هذه الجراحة؟", answer: "تختلف حسب نوع ومدى الإصابة، وتُشرح بالتفصيل خلال جلسة الاستشارة." },
      ],
    },
    {
      slug: "facial-reconstruction-surgery",
      eyebrow: "إعادة بناء الوجه",
      title: "جراحة إعادة بناء الوجه",
      subtitle: "إعادة بناء شكل ووظيفة الوجه بعد الإصابة أو المرض أو النقص العظمي أو الجراحات السابقة، من خلال تخطيط دقيق ونظرة وظيفية وجمالية معاً.",
      overview:
        "تهدف جراحة إعادة بناء الوجه إلى استعادة شكل ووظيفة الوجه بعد الإصابة أو المرض أو النقص العظمي أو الجراحات السابقة — من خلال تخطيط دقيق يجمع بين الوظيفة والجمال معاً، وليس المظهر فقط.",
      suitableForHeading: "لمن تناسب هذه الجراحة عادةً؟",
      suitableFor: [
        "من لديهم نقص عظمي أو نسيجي في الوجه ناتج عن إصابة أو مرض أو جراحة سابقة",
        "من لديهم تشوه متبقٍ بعد كسر أو صدمة",
        "من يحتاجون إلى إعادة بناء وظيفية وجمالية للوجه في آن واحد",
      ],
      consultationPathHeading: "مسار الاستشارة",
      consultationPath: "تُحدَّد خطة إعادة البناء فقط بعد مراجعة دقيقة للحالة الراهنة للوجه، وبتصوير متخصص عند الحاجة.",
      processHeading: "مراحل العلاج",
      process: [
        { title: "الاستشارة الأولية", body: "مراجعة سبب ومدى النقص أو التشوه في الوجه." },
        { title: "التقييم المتخصص", body: "مراجعة التصوير أو نموذج ثلاثي الأبعاد عند الحاجة." },
        { title: "تخطيط إعادة البناء", body: "تصميم خطة إعادة بناء مرحلية تناسب حالة المريض." },
        { title: "الجراحة والمتابعة", body: "تنفيذ الجراحة والمرافقة خلال فترة التعافي." },
      ],
      faqHeading: "أسئلة شائعة",
      faq: [
        { question: "هل إعادة بناء الوجه إجراء تجميلي فقط؟", answer: "لا، الهدف الأساسي في كثير من الحالات هو استعادة الوظيفة الطبيعية للوجه، ويرافق ذلك تحسّن في المظهر." },
        { question: "هل تُجرى هذه الجراحة على مرحلة واحدة؟", answer: "حسب مدى إعادة البناء المطلوبة، قد يُخطَّط لها على مرحلة أو عدة مراحل؛ يُحدَّد ذلك خلال الاستشارة." },
        { question: "متى يجب أن أتقدم بعد الإصابة الأولية؟", answer: "يعتمد التوقيت على نوع الإصابة والحالة الراهنة، ويُفضَّل تقييمها في الاستشارة في أقرب وقت ممكن." },
      ],
    },
  ],
