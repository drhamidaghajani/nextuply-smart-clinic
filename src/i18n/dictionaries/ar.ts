...
export const assistantFlow = {
  ...
  aiConversation: {
    ...
    hasXrayReply: "ممتاز — يرجى إحضار الصورة أو الـCBCT إلى جلسة الاستشارة ليتمكن فريق العيادة من مراجعتها بدقة.",
    noXrayReply: "لا مشكلة — سيرشدكم فريق العيادة في جلسة الاستشارة إلى كيفية الحصول على صورة أو CBCT.",
  },
  contextualAsk: {
