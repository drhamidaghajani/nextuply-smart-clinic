...
export const assistantFlow = {
  ...
  jawConcernChips: {
    frontBack: {
      ...
      reply:
        "تقدم أو تراجع الفك يتعلق عادة بالعلاقة بين الفك العلوي والسفلي، ويُقيَّم بدقة أكبر عبر الصور الشعاعية (السيفالومتري). في جلسة الاستشارة، يراجع فريق العيادة ما إذا كانت جراحة الفك ضرورية أو يكفي حل أكثر محدودية.",
    },
    deviation: {
      label: "عدم تناسق الفك",
      reply: "عدم تناسق الفك عادة يحتاج تقييمًا ثلاثي الأبعاد للوجه وأحيانًا صورة CBCT لتحديد مقدار وسبب عدم التناسق. يتم هذا التقييم في جلسة استشارة حضورية.",
    },
    bite: {
      label: "مشكلة في المضغ أو إطباق الأسنان",
      reply: "مشكلة المضغ أو عدم إطباق الأسنان بشكل صحيح من العلامات المهمة لمراجعة جراحة الفك، وعادة تُقيَّم مع تقييم تقويم الأسنان.",
    },
    aesthetics: {
      label: "تجميل الذقن أو شكل الوجه",
      reply: "إذا كان انزعاجكم الأساسي هو فقط شكل الذقن أو تجميل الوجه، فقد يكفي إجراء أكثر محدودية (مثل جراحة الذقن) بدلاً من جراحة الفك الكاملة — يُحدَّد ذلك في الفحص.",
    },
  },
  leadForm: {
